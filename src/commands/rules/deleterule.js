...
module.exports = class extends Command {
    constructor(client) {
        super(client, {
            ...
            aliases: ["dr"],
            group: "rules",
            memberName: "deleterule",
            description: "Deletes a rule for the server or a channel.",
            guildOnly: true,
    ...
    async run(msg, {subcommand}) {
        ...
        //     // Delete the rule
        //     ruleset.rules.splice(ruleNum - 1, 1);
        // }
        // else {
        //     // Get the channel
        ...
        //     // Delete the rule
        //     ruleset[channel.id].rules.splice(ruleNum + 1, 1);
        // }
        ...
        // Delete the rule
        ruleset[channel.id].splice(ruleNum + 1, 1);

        await msg.guild.settings.set("ruleset", ruleset); // Save changes
        await msg.success("Rule deleted successfully.");
    }
